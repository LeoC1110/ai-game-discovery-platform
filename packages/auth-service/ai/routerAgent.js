...
const RECOMMENDATION_PATTERNS = [
  ...
  /(求推荐|帮我推荐|给我推荐|推荐几个|推荐一些|来点推荐|来点游戏|来点好玩的|想玩什么|有什么好玩的|有啥好玩的|找点游戏|给我来点|安排点|整点)/,
  /(我想玩点|想玩点|想找点|想来点|想找一些|想推荐|我想找).*(游戏|好玩的|能玩的|可玩的|轻松的|休闲的|治愈的|高分的)/,
  /(推荐|建议|找|来点|给我点).*(游戏|好玩的|能玩的|可玩的)/,
];
...
const CONTEXT_BASED_RECOMMENDATION_PATTERNS = [
  ...
  /(多人|合作).*(游戏|推荐|建议)/,
  /(求推荐|帮我推荐|给我推荐|推荐几个|推荐一些|来点推荐|来点游戏|来点好玩的).*(轻松|休闲|治愈|周末|短一点|剧情|新手友好|适合新手|多人|合作|开放世界|高分|好玩)/,
  /(轻松|休闲|治愈|周末|短一点|剧情|新手友好|适合新手|多人|合作|开放世界|高分|好玩).*(游戏|推荐|建议)/,
  /(我想玩点|想玩点|想找点|想来点|想找一些|想推荐|我想找).*(轻松|休闲|治愈|周末|短一点|剧情|新手友好|适合新手|开放世界|高分|好玩)/,
];
